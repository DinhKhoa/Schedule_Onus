  ...
  return (
    <div className="profile-container">
      <div className="page-header" style={{ marginBottom: 32, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
        <h1 className="page-title" style={{ fontSize: 24, fontWeight: 700, color: '#111827', marginBottom: 4 }}>Hồ sơ PT</h1>
        <p className="page-subtitle" style={{ color: '#6B7280', fontSize: 14 }}>Quản lý thông tin cá nhân của huấn luyện viên</p>
      </div>
      ...
      <div className="card profile-card">
        <div className="profile-layout">
          ...
          <div className="profile-left">
            ...
            <div className="role-text">Huấn luyện viên (PT)</div>
          </div>
